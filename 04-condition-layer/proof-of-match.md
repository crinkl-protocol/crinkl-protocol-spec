...
A RewardCommitment may be produced only after a valid ProofOfMatch. The ProofOfMatch does not define reward math; it only proves that the selected epoch's condition was satisfied.
