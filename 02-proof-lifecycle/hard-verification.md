...
Hard verification produces the canonical Spend record, which can be packaged as a Spend Attestation Token for downstream verification (see ../03-portability/spend-attestation-token.md).
