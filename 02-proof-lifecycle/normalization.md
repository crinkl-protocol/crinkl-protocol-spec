...
| Field | Normalization |
|-------|---------------|
| storeId | See ../01-core/canonicalization.md storeId rules |
...
| cbsaCode (optional) | CBSA metro area code or non-metro fallback — derived from store location, not receipt text (see `../01-core/canonicalization.md#cbsacode`) |
