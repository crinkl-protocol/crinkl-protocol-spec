...
- **Spend Attestation Token:** portable, identity-excluded claim about canonical Spend attestation for a `spendId` (see `../03-portability/spend-attestation-token.md`)
- **Reward Commitment Token:** downstream Merkle inclusion proof for committed rewards (see `../05-reward-and-settlement/reward-commitment.md`)
- **Verified GMV Token:** downstream aggregate spend snapshot (see `../05-reward-and-settlement/gmv-token.md`)
- **Verified Spend Distribution Token:** downstream dimensional aggregate snapshot (see `../05-reward-and-settlement/distribution-token.md`)
