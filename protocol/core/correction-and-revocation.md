...
**Fraud flagging (normative):** `FRAUD_FLAGGED` is a spend-stream event that is observational and MUST NOT participate in attestation state transitions (see `../protocol/core/spend-event.md#fraud_flagged-event`).
