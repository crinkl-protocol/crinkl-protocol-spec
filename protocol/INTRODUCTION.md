...
The Reward Ledger is append-only; the protocol does not define clawback events. Reward amounts, formulas, and payout rules are application-layer (see REWARD_LAYER.md).
...
In probabilistic domains such as OCR, Crinkl separates epistemic truth from economic action; see the Economic Reinforcement Invariant in ABSTRACT.md.

---

For invariants and protocol-level properties, see ABSTRACT.md. For terms, see GLOSSARY.md.
