...
- `conformance/vectors/v1/vectors/zk.h2PromoOpenMin.v1.json`
- `conformance/vectors/v1/zk/h2-promo-open-min-v1/valid-proof.json`
- `conformance/vectors/v1/zk/h2-promo-open-min-v1/spend-token.json`
- `conformance/vectors/v1/zk/h2-promo-open-min-v1/manifest.json`
- `conformance/vectors/v1/zk/h2-promo-open-min-v1/fixture-metadata.json`
- `governance/zk-beta-release-checklist.md`
