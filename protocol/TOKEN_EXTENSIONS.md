...
>
> Core token definitions and verification procedures live in **TOKENS.md**.
...
See COMMITMENT_LAYER.md for the normative structures and verification rules.
...
See `STORE_REGISTRY.md` for the normative snapshot/leaf/proof shapes and hashing rules.
