...
**Status:** normative placeholder; statement binding/derivation rules are defined in `../06-extensions/zk-foundation.md` and `../06-extensions/zk-proof-extension.md`.
...
**Status:** normative placeholder; the exact binding requirements for redemption are defined in `../06-extensions/zk-foundation.md` (and may evolve without changing core token classes).
