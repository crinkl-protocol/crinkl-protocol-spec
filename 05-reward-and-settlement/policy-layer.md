...
- redemption availability, solvency, or reserves (`../03-portability/spend-attestation-token.md` explicit non-claims),
...
- RFC 8785 canonical JSON serialization (`../01-core/canonicalization.md#serialization`)
...
- Reward commitments do NOT prove solvency, reserves, or redemption availability (`../03-portability/spend-attestation-token.md`).
