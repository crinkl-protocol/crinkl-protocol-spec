...
- A spend is included in a GMV window according to the canonical spend attestation timestamp produced by the spend-stream state machine (../01-core/verification-state.md), not raw receipt-local timestamps.
