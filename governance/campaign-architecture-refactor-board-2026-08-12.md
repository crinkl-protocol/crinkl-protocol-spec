...
| CA-03 | Record collision table and legacy-to-canonical mapping | complete | migration document |
...
| CA-05 | Add compatibility-safe vNext schemas | complete | campaign schema directory |
