...
2. **Normative protocol spec**
   - `crinkl-protocol-spec/protocol/purpose/*.md`
...
5. **Reference material (non-normative)**
   - `crinkl-protocol-spec/protocol/extensions/**`, `conformance/**`, diagrams, examples, prose notes.
...
- `protocol/purpose/`, `protocol/core/`, `protocol/core/`, `protocol/portability/`
  - Canonical proof semantics + invariants (what the protocol *means*).
  - Canonical byte rules (what is hashed/signed and how).
- `protocol/applications/conditions/`, `protocol/applications/economics/`, `protocol/extensions/`
