...
|---|-------|-----------------|--------------|
| 1 | `Merchant Alpha` | `merchant alpha` | Lowercase |
| 2 | `market-alpha` | `market-alpha` | Preserve hyphens, lowercase |
| 3 | `Market★Alpha` | `marketalpha` | Strip non-alphanumeric, lowercase |
| 4 | `TRADER PLACE'S` | `trader-places` | Strip apostrophe, spaces to hyphens, lowercase |
| 5 | `7-Shop` | `7-shop` | Preserve leading digit, lowercase |
| 6 | `Café Münchën` | `cafe-munchen` | NFKD normalize, strip diacritics, lowercase |
| 7 | `  Merchant Beta  ` | `merchant beta` | Trim whitespace, lowercase |
| 8 | `Best---Shop` | `best-shop` | Collapse multiple hyphens, lowercase |
| 9 | `Care/pharmacy` | `care-pharmacy` | Slash to hyphen, lowercase |
| 10 | `A&P` | `a-p` | Ampersand to hyphen, lowercase |
| 11 | `Fresh Foods Market #1234` | `fresh-foods-market-1234` | Spaces to hyphens, strip hash, lowercase |
