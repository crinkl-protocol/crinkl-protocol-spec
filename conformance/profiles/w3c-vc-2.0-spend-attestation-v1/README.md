...
```bash
python3 conformance/profiles/w3c-vc-2.0-spend-attestation-v1/scripts/check_w3c_vc_2_0_spend_attestation_bundle.py
node conformance/profiles/w3c-vc-2.0-spend-attestation-v1/scripts/check_w3c_spend_attestation_credential_vectors.mjs
node conformance/profiles/w3c-vc-2.0-spend-attestation-v1/scripts/generate_w3c_bitstring_status_list_vectors.mjs
node conformance/profiles/w3c-vc-2.0-spend-attestation-v1/scripts/check_w3c_bitstring_status_list_vectors.mjs
python3 conformance/profiles/w3c-vc-2.0-spend-attestation-v1/conformance/w3c-vc-2.0/v1/validate_draft202012.py --check
```
