...
stated in [`../../../protocol/extensions/campaign-direct-buyer-reward-profile.md`](../../../protocol/extensions/campaign-direct-buyer-reward-profile.md).
...
python3 conformance/profiles/campaign-direct-buyer-reward-v1/scripts/generate_campaign_direct_reward_profile_vectors.py --check
```
