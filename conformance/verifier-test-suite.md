...
`conformance/profiles/`, receive no shell interpolation or manifest-supplied arguments,
...
The public verifier MUST verify the proof from the artifact and registry manifest. A hosted Crinkl verifier response is not sufficient conformance evidence by itself. The beta release checklist is `../governance/zk-beta-release-checklist.md`.
