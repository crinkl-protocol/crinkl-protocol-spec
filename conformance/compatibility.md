...
| `v1.0.0-rc.8` source candidate | Unreviewed suite-5 successor candidate. | It records the additive rc.7 reward-commitment erratum and candidate-only adopted source pin `4a9dff4002a4016638e213d2f6dce71c4d371515`; it is not released, runtime-consumed, deployed, or authority-active. |
