...
EXPECTED_SUCCESSOR_COMMIT = "4ae7261c4b29de046ce268a3be126b92683579ec"
...
def validate_local(root: Path, erratum: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    require(successor_receipt == {"algorithm": "sha256", "digest": EXPECTED_SUCCESSOR_RECEIPT, "lineCount": 22, "serialization": "oldIdentifier<TAB>successorIdentifier<TAB>successorPath<TAB>successorSha256<LF>", "state": "REVIEWED_SOURCE_NOT_ADOPTED_MAIN_OR_PUBLIC_SPEC_OR_RELEASED_OR_RUNTIME_OR_DEPLOYED"}, "successor receipt metadata drift")
    ...
    require(isinstance(successor_source, dict) and successor_source == {"repository": "crinkl-protocol", "commit": EXPECTED_SUCCESSOR_COMMIT, "path": EXPECTED_MAP_PATH, "sha256": EXPECTED_MAP_SHA256, "recordCount": 22, "state": "REVIEWED_SOURCE_NOT_ADOPTED_MAIN_OR_PUBLIC_SPEC_OR_RELEASED_OR_RUNTIME_OR_DEPLOYED"}, "D3.1 successor-source map pin drift")
    standing = erratum.get("standing")
    require(standing == {"releasedHistory": "IMMUTABLE", "identifierResolution": "ID_ONLY_RESOLUTION_UNSAFE_WHEN_BYTES_CONFLICT", "successorState": "REVIEWED_SOURCE_NOT_ADOPTED_MAIN_OR_PUBLIC_SPEC_OR_RELEASED_OR_RUNTIME_OR_DEPLOYED", "consumerMigration": "EXPLICIT_AND_INACTIVE"}, "erratum standing/compatibility drift")
    return erratum
