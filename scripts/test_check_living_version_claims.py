...
def main() -> int:
    ...
    mutations = [
        ...
        ("latest release wrong", "07-conformance/compatibility.md", "`v1.0.0-rc.7` is the latest released public package", "`v1.0.0-rc.3` is the latest released public package"),
